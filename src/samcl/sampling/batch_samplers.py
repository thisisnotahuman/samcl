...
from samcl.semantic.relations import SemanticRelationOracle
...
class RandomBatchSampler(BatchSampler):
    ...
    def __init__(
        self, dataset: CocoPairsDataset | SayCamPairsDataset | WdsPairsDataset, *, batch_size: int, drop_last: bool = True, seed: int = 0
    ):
